...
3. For the frontend interface, go to Sitecore package installer and install the package Avalara Tax Package-9.0.0.zip [See figure 1.0 on the Avalara Setup Reference.docx](docs/AvalaraSetupReference.docx)
