...
namespace Sitecore.Commerce.Plugin.Avalara
{
    ...
    public static class Constants
    {
        ...
        public struct Tax
        {
            ...
            /// 
            /// </summary>
            public const string AvaMessagesItemPath = "/sitecore/system/Modules/Avalara/AvaTaxMessages";


            public const string EmptyAddressResponseFromCommerce = "Empty Address Response from Commerce";
            public const string ErrorConnectingToCommerce = "Error Connecting to Commerce";
            public const string CustomerMessage = "Customer Message";



            public const string AvaTaxSettingsMissing = "AvaTax Settings Missing";
            public const string AvaTaxIsDisabled = "AvaTax Is Disabled";
            public const string ConnectionSuccessful = "Connection Successful";
            public const string ErrorConnectingInvalidCredentials = "Error Connecting Invalid Credentials";
